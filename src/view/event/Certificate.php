...
<div class="cert2">
    <table width="100%">
        <tr>
            <td width="10%"><img src="http://mercurio.natanaelsimoes.com/src/assets/images/brasao.jpg" style="height: 150px"></td>
            ...
            <td width="10%"><p class="text-right"><img src="http://mercurio.natanaelsimoes.com/src/assets/images/ifro.jpg" style="height: 150px"></p></td>
        </tr>
        <tr>
            <td colspan="3">
                <h1 class="text-center" style="font-size: 65pt">Certificado</h1>                    
                <p class="text-center" style="font-size: 14pt">Certificamos que<br><span style="font-size:22pt"><b><?= ucwords($user->getCompleteName()) ?></b></span><br>participou do  
                    <i>I Encontro de Informática do Instituto Federal de Rondônia</i>, 
                ...
                <h3 class="text-center" style="font-size:16pt"><i>Ariquemes, 05 de janeiro de 2015.</i></h3>
            </td>
        </tr>
    </table>
    <table width="100%">            
        <tr>
            <td width="33.33%"><p class="text-center" style="margin-top: 10px;"><img src="http://mercurio.natanaelsimoes.com/src/assets/images/osvino.jpg" style="height: 166px"></p></td>
            <td width="33.33%"><p class="text-center" style="font-size: 12pt; border-top: 2px solid black">Titular do Certificado</p></td>
            <td width="33.33%"><p class="text-center" style="margin-top: 10px; padding-top: 30px"><img src="http://mercurio.natanaelsimoes.com/src/assets/images/juliana.jpg" style="height: 126px"></p></td>
        </tr>
    </table>                        
</div>
<div class="cert">
