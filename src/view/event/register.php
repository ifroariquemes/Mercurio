...
<div class="row">
    <div class="col-md-12">
        <p class="text-right">
            ...
            <?php else : ?>
                <button class="btn btn-lg btn-success" type="button" onclick="evt.register(event)"><i class="fa fa-save"></i> <span data-i18n="event:button.register">Registrar</span></button>
            <?php endif ?>
        </p>
    </div>
</div>
