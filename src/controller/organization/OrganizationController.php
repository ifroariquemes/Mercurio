...
class OrganizationController
{
    ...
    public static function manage()
    {
        ...
        $_MyCookie->loadView('organization', 'manage'
                , array(
            'organizations' => $data,
            'currentPage' => $urlPage,
    ...
    public static function add()
    {
        ...
        $_MyCookie->loadView('organization', 'edit', array('organization' => $organization, 'action' => 'add'));
    }
    ...
    public static function edit()
    {
        ...
        $_MyCookie->loadView('organization', 'edit', array('action' => 'edit', 'organization' => $organization));
    }
