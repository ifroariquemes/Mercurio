            ...
            <table width="100%">
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <p class="text-center" style="font-size: 14pt">Certificamos que<br><span style="font-size:22pt"><b><?= ucwords($speaker) ?></b></span><br>
                            ministrou <i><?= $tipo ?></i> intitulado(a) <i>"<?= $activity->getName() ?>"</i> em <i><?= $event->getName() ?></i>, com um total de <b><?= $horas ?> horas</b>, 
