...
<div class="row">    
    <div class="col-lg-12 text-right">        
        <form id="FrmSearch" class="form-inline" onsubmit="frequency.searchEvent(event)">            
...
<div id="lstData" class="row">
    <div class="col-lg-12">        
        <?php
        if (!empty($data)) :
            $_MyCookie->LoadView('frequency', 'Manage.table', $data);
        else :
            ?>
            <?php _e('There is no Event happening at this moment. If your event ended recently, try search for it (returns from now to 10 days ago)', 'frequency') ?>.</a>
        <?php endif; ?>
