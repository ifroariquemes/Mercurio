    ...
    public function CreateBuildJS() {
        ...
        if ($this->CheckPassword()) {
            ...
            if ($myCookieConfiguration->build->use_jquery) {
                ...
                fwrite($fp, "       select2: \"vendor/ivaynberg/select2/select2\",\n");
                array_push($jsFilesId, 'jquery', 'i18next', 'select2');
            }
            if ($myCookieConfiguration->build->use_bootstrap) {
                ...
                fwrite($fp, "       datepicker: \"vendor/eternicode/bootstrap-datepicker/js/bootstrap-datepicker\",\n");
                array_push($jsFilesId, 'datepicker');
            }
    ...
    private function CreateBuildCSSConfig() {
        ...
        if ($this->CheckPassword()) {
            ...
            if ($myCookieConfiguration->build->use_bootstrap) {
                ...
                fwrite($fp, "\n@import url('../vendor/eternicode/bootstrap-datepicker/css/datepicker3.css');");
            }
            fwrite($fp, "\n@import url('../vendor/ivaynberg/select2/select2.css');");
            fwrite($fp, "\n@import url('../vendor/ivaynberg/select2/select2-bootstrap.css');");
